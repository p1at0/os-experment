...
int main( int argc,char *argv[] )
{
    ...
    gtk_window_set_title (GTK_WINDOW (window), "ManagerCat");  
    gtk_widget_set_size_request (window, 550, 450);  
    ...
    sprintf(bufferf3, "ManagerCat  Pro. Version\t\t\t\n\nCopyright@2013  Henye\t\t\t");
